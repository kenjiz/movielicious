...
class ReviewModel extends Review {
  ...
  factory ReviewModel.fromMap(Map<String, dynamic> map) {
    return ReviewModel(
      ...
      authorDetails: AuthorDetailsModel.fromMap(map['author_details'] as Map<String, dynamic>),
...
class AuthorDetailsModel extends AuthorDetails {
  ...
  factory AuthorDetailsModel.fromMap(Map<String, dynamic> map) => AuthorDetailsModel(
