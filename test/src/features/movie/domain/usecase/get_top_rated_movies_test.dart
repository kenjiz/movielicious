...
import 'package:movielicious/src/features/movies/domain/usecase/get_top_rated_movies.dart';
...
void main() {
  ...
  const tMovieCategory = ListCategory.topRated;
  ...
  test('should get [MovieRespons] from MovieRepository', () async {
    // Arrange
