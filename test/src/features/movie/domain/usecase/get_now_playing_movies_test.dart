...
import 'package:movielicious/src/features/movies/domain/usecase/get_now_playing_movies.dart';
...
void main() {
  ...
  test('should get now playing [MovieResponse] from MovieRepository', () async {
    // Arrange
